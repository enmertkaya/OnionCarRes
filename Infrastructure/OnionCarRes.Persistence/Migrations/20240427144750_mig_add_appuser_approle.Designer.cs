...
namespace OnionCarRes.Persistence.Migrations
{
    ...
    [Migration("20240427144750_mig_add_appuser_approle")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.About", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Author", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Banner", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Brand", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Car", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.CarDescription", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.CarFeature", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.CarPricing", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.FooterAddress", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Location", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Pricing", b =>
                {
                    b.Property<int>("PricingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.RentACar", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.SocialMedia", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.AppUser", b =>
                {
                    b.HasOne("OnionCarRes.Domain.Entities.AppRole", "AppRole")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Blog", b =>
                {
                    b.HasOne("OnionCarRes.Domain.Entities.Author", "Author")
                        .WithMany("Blogs")
                        .HasForeignKey("AuthorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnionCarRes.Domain.Entities.Category", "Category")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Car", b =>
                {
                    b.HasOne("OnionCarRes.Domain.Entities.Brand", "Brand")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.CarFeature", b =>
                {
                    ...
                    b.HasOne("OnionCarRes.Domain.Entities.Feature", "Feature")
                        .WithMany("CarFeatures")
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.CarPricing", b =>
                {
                    ...
                    b.HasOne("OnionCarRes.Domain.Entities.Pricing", "Pricing")
                        .WithMany("CarPricings")
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.RentACar", b =>
                {
                    ...
                    b.HasOne("OnionCarRes.Domain.Entities.Location", "Location")
                        .WithMany("RentACars")
            ...
            modelBuilder.Entity("OnionCarRes.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("OnionCarRes.Domain.Entities.Location", "DropOffLocation")
                        .WithMany("DropOffReservation")
                        .HasForeignKey("DropOffLocationID")
                        .IsRequired();

                    b.HasOne("OnionCarRes.Domain.Entities.Location", "PickUpLocation")
