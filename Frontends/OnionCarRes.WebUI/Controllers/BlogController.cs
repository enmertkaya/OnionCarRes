...
namespace OnionCarRes.WebUI.Controllers
{
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> BlogDetail(int id)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var responseMessage2 = await client.GetAsync($"https://localhost:7063/api/Comments/CommentCountByBlog?id=" + id);
        ...
        public async Task<IActionResult> AddComment(CreateCommentDto createCommentDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7063/api/Comments/CreateCommentWithMediator", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
