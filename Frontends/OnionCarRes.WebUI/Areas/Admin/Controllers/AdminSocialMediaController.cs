...
using System.Text;
using OnionCarRes.Dto.SocialMediaDtos;
...
namespace OnionCarRes.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminSocialMediaController : Controller
    {
        ...
        public async Task<IActionResult> CreateSocialMedia(CreateSocialMediaDto createSocialMediaDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7063/api/SocialMedias", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> UpdateSocialMedia(UpdateSocialMediaDto updateSocialMediaDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync("https://localhost:7063/api/SocialMedias/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "AdminSocialMedia", new { area = "Admin" });
            }
